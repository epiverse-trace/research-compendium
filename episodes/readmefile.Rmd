...
In Markdown, the `Header 2` generates an underline that can help to isolate sections of the structure we choosed.

![](fig/markdown-header.png)

Remove one `#` from all the main headers. This edit generates a final `README` file that look like this:
