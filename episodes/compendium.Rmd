---
title: 'Start a Research compendium'
teaching: 10
exercises: 2
---
...
We understand that creativity can be “messy”. You will be able to handle it in the present, but your collaborators (and the future you) may have problems understanding it. Reproducibility is as much about the humans that interact with the code as the machines that need to run it ([Campitelli and Corrales, 2022](https://eliocamp.github.io/reproducibility-with-r/materials/day1/02-projects/)).
...
Features like a __Compendium template__ and __Version control__ increase the quality of the software. A compendium follows a logical and familiar structure. A version control software registers the project's history and how one or multiple contributors wrote code and made decisions. Additionally, __Community files__ consider any gaps in the community of users to facilitate their participation and how to interact with maintainers.
