...
A key feature of this practice is the `make.R` file. With this file, and any other more sophisticated alternatives like `GNU Make` or `{targets}`, we now are sure that we:
