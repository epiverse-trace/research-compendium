...
The `make.R` file helps to automate the your whole analysis project. This is the only `.R` file stored in the root of the project given by the `{rcompendium}` template.
...
### this can go to readme?

create a easy to naviagete with
