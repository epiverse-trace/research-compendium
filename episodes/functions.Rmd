...
- Where to add my functions?
- How to write my functions?
- How to create a website for my function documentation?
...
Let's compare the `fun-demo.R` file and the website format:
...
Reproducible research is also defined as the practice of _describing_ and _documenting_ the research process in such a way that another researcher can re-run the software on the same data input to get the same outputs.

Offering proper documentation for your custom functions with easy navigation in a website can complement these efforts!
